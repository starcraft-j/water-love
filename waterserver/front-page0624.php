...
<div id="main_contents" class="topcontent">
              ...
              <tr>
                <td colspan="6" class="text-center bblue">
                  <h3>
                    ...
                    <a href="<?php the_permalink(); ?>" class="prrrr" rel="external nofollow" target="_blank"><span class="rank-txt"><?php the_title(); ?></span></a>
                  </h3>
                </td>
              </tr>
              <tr>
                <td colspan="2" class="gazo">
                  <a href="<?php the_permalink(); ?>" rel="external nofollow" class="prrrr">
                  ...
                  <?php
                        ...
                        if ($gazo2) : ?>
                    <a href="<?php the_permalink(); ?>?type=2" rel="external nofollow" class="prrrr">
                  ...
                  <?php
                        ...
                        if ($gazo3) : ?>
                    <a href="<?php the_permalink(); ?>?type=3" rel="external nofollow" class="prrrr">
                ...
                <td colspan="4" valign="middle" class="text-center">
                  ...
                  <a href="<?php the_permalink(); ?>" target="_blank" class="prrrr">⇒ <?php the_title(); ?>の詳細・申込はこちら</a>
                </td>
              </tr>
              <tr>
                <td colspan="6" class="text-center bblue">
  ...
  $campaignTitle = get_field("campaign_title");
   ...
   ?>
                  ...
                  <a href="<?php the_permalink(); ?>" target="_blank" class="button grad prrrr"><?php the_title(); ?>の公式サイトはこちら</a>
                  <p>&nbsp;</p>
                </td>
              </tr>
            <?php } else { ?>
          ...
          <tbody>
            <tr>
              <td class="text-center bblue">
                <h3><span class="aka"><?php echo date("n月"); ?>のPICK UPサーバー</span> <a href="<?php the_permalink(); ?>" rel="external nofollow" target="_blank" class="prrrr">『<?php the_title(); ?>』</a></h3>
              </td>
            </tr>
            <tr>
              <td class="gazo">
            ...
            <tr>
              <td>
                <div class="naiyo">
                  ...
                  <?php echo date("Y年n月"); ?>のPICK UPサーバーは<a href="<?php the_permalink(); ?>" rel="external nofollow" target="_blank" class="prrrr"><?php the_title(); ?>！</a><br>
                  <?php the_field('pickup_description'); ?>
                </div>
                <?php if (!is_mobile()) { ?>
                  <br><br><a href="<?php the_permalink(); ?>" target="_blank" class="button grad pickbutton prrrr"><?php the_title(); ?>の公式サイトはこちら</a>
                <?php } else { ?>

                  <a href="<?php the_permalink(); ?>" target="_blank" class="button grad pickbutton prrrr">公式サイトはこちらから</a>
                <?php } ?>
              </td>
            </tr>
          </tbody>
  ...
  <div style="text-align: center; margin-top: 30px">
    <a style="display:block; margin: auto; width: 600px" href="https://waterserver.love/link/frecious.html?type=4" rel="external nofollow" target="_blank" class="prrrr">
  ...
  <div style="text-align: center; padding: 40px 10px 0;">
    <a style="display:block;  width: 90%; margin: auto;" href="https://waterserver.love/link/frecious.html?type=4" rel="external nofollow" target="_blank" class="prrrr">
